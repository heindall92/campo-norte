-- Campo Norte — Data Hub + Auth (Postgres / Supabase)
...
--      update public.mps_profiles set role = 'admin' where email = 'ana@campo-norte.demo';
--
-- 3) Asigna el resto de roles:
--      update public.mps_profiles set role = 'booking' where email = 'laura@campo-norte.demo';
--      update public.mps_profiles set role = 'ops'     where email = 'david@campo-norte.demo';
--      update public.mps_profiles set role = 'guide'   where email = 'ramon@campo-norte.demo';
--
