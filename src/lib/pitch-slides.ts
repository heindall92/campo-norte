...
const es: PitchSlide[] = [
  {
    kicker: "Propuesta · Campo Norte",
    title: "Crecer sin perder lo que os hace únicos",
    subtitle:
      "Un sistema interno para ordenar el negocio, liberar tiempo de la fundadora y llegar al millón — sin que ninguna máquina hable con el viajero.",
    blocks: [
      {
        type: "text",
      ...
      },
      {
        type: "bullets",
        items: [
          "Ya hay un demo vivo para enseñar en la reunión: campo-norte.vercel.app",
  ...
  },
  {
    ...
    blocks: [
      {
        type: "quote",
        text: "El producto es 5 estrellas. El cuello de botella es el día a día: datos sueltos y todo pasando por Ana.",
      },
      {
        type: "bullets",
        items: [
          "Los viajes se venden solos por calidad — el sistema detrás no acompaña",
          "Excel + correo de la fundadora + newsletter = nadie ve el negocio entero",
          "Ana tria leads, hace seguimiento y piensa contenido: horas que deberían ir a cerrar y cuidar",
        ],
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        rows: [
          ...
          ["Ana demasiado operativo", "Crítica", "Avisos internos + lista corta de trabajo"],
  ...
  },
  {
    ...
    title: "Qué enseñar en la reunión con la fundadora",
    blocks: [
      {
        type: "steps",
        items: [
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Laura o Ana pueden importar y exportar sin pedir a un técnico",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "quote",
        text: "El sistema prepara la lista. Ana o Laura escriben desde su propio correo o WhatsApp.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: "text",
        text: "Frase de 10 segundos para la fundadora: este módulo prepara las facturas con el régimen de agencias de viajes y deja el camino listo para Veri*FACTU (2027).",
      },
      {
        type: "bullets",
        items: [
  ...
  },
  {
    ...
    title: "Menos «pregúntale a la fundadora» · más borradores listos",
    blocks: [
      {
        type: "cards",
        items: [
    ...
    blocks: [
      {
        ...
        items: [
          ...
          "Semana 1 · sesión con la fundadora y Laura · importar Excel / Brevo reales",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "text",
        text: "Yoandy Ramírez Delgado · Growth Builder · campo-norte.vercel.app",
      },
    ],
...
const en: PitchSlide[] = [
  {
    kicker: "Proposal · Campo Norte",
    title: "Grow without losing what makes you unique",
    subtitle:
      "An internal system to organise the business, free Ana’s time and reach €1M — without any machine messaging the traveller.",
    blocks: [
      { type: "text", text: "Yoandy Ramírez Delgado · Growth Builder · freelance proposal" },
      {
        type: "bullets",
        items: [
          "Live demo for the meeting: campo-norte.vercel.app",
  ...
  },
  {
    ...
    blocks: [
      {
        type: "quote",
        text: "The product is 5 stars. The bottleneck is daily ops: scattered data and everything through Ana.",
      },
      {
        type: "bullets",
        items: [
          "Trips sell on quality — the system behind doesn’t keep up",
          "Sheets + Ana’s inbox + newsletter = nobody sees the whole business",
          "Ana sorts leads, follows up and drafts content — hours that should close and care",
        ],
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        rows: [
          ...
          ["Ana too operational", "Critical", "Internal alerts + short work list"],
  ...
  },
  {
    ...
    title: "What to show Ana in the meeting",
    blocks: [
      {
        type: "steps",
        items: [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "text",
        text: "10s line for Ana: prepares invoices under the travel-agency scheme and the path to Veri*FACTU (2027).",
      },
    ],
  },
  {
    kicker: "Team time",
    title: "Fewer “ask Ana” moments · more ready drafts",
    blocks: [
      {
        type: "cards",
        items: [
    ...
    blocks: [
      {
        ...
        items: [
          ...
          "Week 1 · session with Ana & Laura · import real sheets / Brevo",
