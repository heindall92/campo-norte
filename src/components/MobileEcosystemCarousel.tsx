...
const SLIDES: EcosystemSlide[] = [
  {
    ...
    subEs: "Lo publicado en campo-norte.demo · sin vender, solo verificar",
    subEn: "What's live on campo-norte.demo · verify, don't sell",
    ctaEs: "Abrir web",
    ctaEn: "Open site",
    href: "https://campo-norte.demo",
  },
  {
    id: "instagram",
    from: "#a02cbb",
  ...
  },
  {
    ...
    subEs: "Campo Norte · uso interno y documentación",
    subEn: "Campo Norte · internal use and docs",
    ctaEs: "Ver soporte",
    ctaEn: "View support",
    action: "support",
  },
